(function() {
    ...
    var db = {
        ...
        loadData: function(filter) {
			...
			console.log(d);
			$.ajax({
						url: 'http://localhost:5000/institution_save?name=asdfsdaf',
						type: 'POST',
						headers: {  'Access-Control-Allow-Origin': 'http://The web site allowed to access' },
							...
							console.log(db.clients);
	 					    ...
	 					    db.clients = [{"Name": "Otto Clay","Age": 61,"Country": 6,"Address": "Ap #897-1459 Quam Avenue"}];
